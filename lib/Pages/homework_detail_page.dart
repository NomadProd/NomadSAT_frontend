...
// в”Ђв”Ђв”Ђ Glass AppBar в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
class _GlassAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      backgroundColor: _kPrimaryDark.withOpacity(0.72),
      ...
      elevation: 0,
      flexibleSpace: ClipRect(child: Container(color: _kPrimary)),
    );
  }
}

// в”Ђв”Ђв”Ђ Full-bleed Hero в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
// в”Ђв”Ђв”Ђ Details Card в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
//  PAGINATED HOMEWORK LIST  (drop-in replacement for wherever you show a list)
// в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ

/// A widget that shows a paginated list of completed homework entries.
/// Shows [pageSize] items at once with Previous / Next navigation.
class PaginatedHomeworkList extends StatefulWidget {
  final List<HomeworkResultInfo> items;
  final int pageSize;

  const PaginatedHomeworkList({
    super.key,
    required this.items,
    this.pageSize = 5,
  });
  ...
  @override
  State<PaginatedHomeworkList> createState() => _PaginatedHomeworkListState();
}

class _PaginatedHomeworkListState extends State<PaginatedHomeworkList> {
  int _page = 0;

  int get _totalPages =>
      (widget.items.length / widget.pageSize).ceil().clamp(1, 9999);

  List<HomeworkResultInfo> get _visible {
  ...
  Widget build(BuildContext context) {
          ...
          child: Column(
            ...
            children: [
              Icon(
                Icons.inbox_rounded,
                size: 48,
                color: _kTextLight.withOpacity(0.5),
              ),
              const SizedBox(height: 12),
              const Text(
    ...
    return Column(
      ...
      children: [
        // в”Ђв”Ђ Visible rows в”Ђв”Ђ
        ...List.generate(_visible.length, (i) {
          final item = _visible[i];
          final isLast = i == _visible.length - 1;
          return _HomeworkResultRow(item: item, showDivider: !isLast);
        }),

        // в”Ђв”Ђ Pagination bar в”Ђв”Ђ
        if (_totalPages > 1) ...[
          const SizedBox(height: 14),
          _PaginationBar(
            currentPage: _page,
        ...
        // в”Ђв”Ђ Page counter в”Ђв”Ђ
        const SizedBox(height: 6),
        Center(
          child: Text(
            'Showing ${_visible.length} of ${widget.items.length}',
            style: const TextStyle(
              color: _kTextLight,
              fontSize: 12,
              fontWeight: FontWeight.w700,
...
class _HomeworkResultRow extends StatelessWidget {
  final HomeworkResultInfo item;
  final bool showDivider;

  const _HomeworkResultRow({required this.item, required this.showDivider});

  @override
  Widget build(BuildContext context) {
    final correct = item.correctTotal;
    final incorrect = item.incorrectTotal;
    final hasScore = correct != null || incorrect != null;
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              ...
              // в”Ђв”Ђ Photo badge в”Ђв”Ђ
              if ((item.photoLink ?? '').isNotEmpty)
                Container(
                  padding: const EdgeInsets.symmetric(
                    horizontal: 8,
                    vertical: 4,
        ...
        if (showDivider) const Divider(height: 1, color: _kBorder),
      ],
    );
  }
}
...
class _NavButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final content = leading
        ? [Icon(icon, size: 18), const SizedBox(width: 4), Text(label)]
        : [Text(label), const SizedBox(width: 4), Icon(icon, size: 18)];
